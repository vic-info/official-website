...
export const layouts: Record<string, Layouts> = {
  ...
  about: {
    lg: [
      { i: "webAgent", x: 0, y: 1, w: 1, h: 4 },
      { i: "chatBot", x: 1, y: 1, w: 2, h: 2 },
      { i: "paper", x: 1, y: 2, w: 1, h: 2 },
      { i: "actions", x: 2, y: 2, w: 2, h: 2 },
      { i: "avatar", x: 0, y: 0, w: 4, h: 2 },
      { i: "iconCloud", x: 3, y: 1, w: 1, h: 2 },
